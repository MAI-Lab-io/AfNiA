  ...
  const steps = [
    {
      ...
      description: 'Provide basic information about your clinic or research center and obtain institutional approval.',
    },
    {
      number: 2,
      icon: Shield,
      title: 'Ensure Ethics Compliance',
      description: 'Confirm all data is anonymized and meets ethical standards with proper participant consent.',
    },
    {
      number: 3,
      icon: Upload,
    ...
    },
    {
      ...
      description: 'Our team reviews your submission for quality and compliance before making it available.',
    },
  ];
    ...
    <div className="py-12">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto text-center mb-12">
          <h1 className="mb-4" style={{ fontSize: '2.5rem', fontWeight: 700 }}>Contribute Data to AfNIA</h1>
        ...
        {/* Steps */}
        <div className="mb-16">
          <h2 className="text-center mb-12" style={{ fontSize: '2rem', fontWeight: 700 }}>How It Works</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {steps.map((step) => (
              <Card key={step.number} className="p-6 text-center">
                ...
                <div className="text-primary mb-2" style={{ fontWeight: 700 }}>Step {step.number}</div>
        ...
        <div className="mb-16 bg-gradient-to-br from-primary/5 to-accent/5 rounded-2xl p-8 md:p-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <h2 className="mb-4" style={{ fontSize: '2rem', fontWeight: 700 }}>Ethical Standards & Anonymization</h2>
        ...
        <div className="max-w-2xl mx-auto">
          <Card className="p-8">
            <h2 className="mb-6" style={{ fontSize: '2rem', fontWeight: 700 }}>Become a Partner</h2>
            <p className="text-muted-foreground mb-6">
        ...
        <div className="mt-16 max-w-3xl mx-auto">
          <h2 className="text-center mb-8" style={{ fontSize: '2rem', fontWeight: 700 }}>Frequently Asked Questions</h2>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    We accept MRI, CT, PET scans and other neuroimaging modalities. Data should be properly anonymized and accompanied by metadata.
                  </p>
                </div>
              </div>
            </Card>
            <Card className="p-6">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    We provide tools and guidelines for proper anonymization. Our team also reviews all submissions to ensure compliance before publication.
                  </p>
                </div>
              </div>
            </Card>
