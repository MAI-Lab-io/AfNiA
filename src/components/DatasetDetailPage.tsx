      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              ...
              <Card className="p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-2xl font-bold">
                      {stats.citationCount.toLocaleString()}
                    </p>
            ...
            {/* Data Access - BraTS-specific block */}
            {dataset.id === "1" && (
              <Card className="p-6 mb-6">
                    ...
                    <tbody>
                      <tr>
                        <td className="p-3 border">
                          Radiology Images and Segmentations - BraTS 2023 Challenge
                        </td>
              ...
              {dataset.accessType === "Open" ? (
                <>
                  <p className="text-muted-foreground mb-6">
                    This dataset is openly available. Complete the Data Use
                    Agreement to download.
                  </p>
                  <Button className="w-full mb-3" onClick={handleAccessDataset}>
                    <Download className="w-4 h-4 mr-2" />
                    Access Dataset
                  </Button>
                </>
                ...
                <>
                  <p className="text-muted-foreground mb-6">
                    This dataset requires approval to access. Submit a request
                    with your research purpose and agree to the data use terms.
                  </p>
                  <Button className="w-full mb-3" onClick={handleAccessDataset}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {relatedDatasets.slice(0, 3).map((related) => (
                <Card
                  ...
                  onClick={() => onViewDataset(related.id)}
                >
