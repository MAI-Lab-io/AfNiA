...
Generated by Repomix on: 2026-01-12 12:00:35
...
import { DataAccessRequestModal } from './DataAccessrequest';
...
## src/components/DataAccessrequest.tsx
...
export function ExplorePage({ datasets, onViewDataset }: ExplorePageProps) {
  ...
  const filters = {
    ...
    accessTypes: ['Open', 'Restricted', 'Coming Soon'],
  };
...
export function LandingPage({ onNavigate, datasets }: LandingPageProps) {
  ...
  <div>
    <div className="mb-8 text-left">
      <h1 className="mb-6">
        <span style={{ fontSize: '3.5rem', fontWeight: 500, color: '#fd9d4eff' }}>
          Welcome to{' '}
        </span>
  ...
  export default defineConfig({
    ...
    resolve: {
      ...
      alias: {
        ...
        'figma:asset/2fd0ff719b84eea33f9e1ff98711f713d18fb538.png': path.resolve(__dirname, './src/assets/2fd0ff719b84eea33f9e1ff98711f713d18fb538.png'),
